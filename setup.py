...
setup(
    ...
    zip_safe=False,
    extras_require={
        'sae': ['sae-lens==3.11.0'],  # to use: pip install -e .[sae] # windows will require pip install sae-lens==3.11.0 --no-dependencies followed by manually installing needed packages
    },
)
