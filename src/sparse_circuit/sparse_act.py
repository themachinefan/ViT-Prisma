## taken directly from https://github.com/saprmarks/feature-circuits 
...
class SparseAct():
    ...
    def __init__(
            self, 
            act = None, # batch, n_ctx, d_sae
            res = None, # batch, n_ctx , d_model
            resc = None, # contracted residual batch n_ctx
            ) -> None:
